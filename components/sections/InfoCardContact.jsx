...
linkText: "[nathan@getsweet.ai](mailto:nathan@getsweet.ai)",
},
{
...
>
{/* Icono */} 
<div className="p-3 rounded-xl bg-linear-to-r from-purple-500 to-pink-500 text-white shrink-0"> <Icon className="w-6 h-6" /> </div>
